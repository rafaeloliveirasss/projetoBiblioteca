        ...
        <div class="container text-center">
            <div class="row align-items-start">
                <div class="col">
                    <form>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Busca por Gênero</label>
                    ...
                    <%                        
                        ...
                        if (request.getParameter("btnBuscar") != null) {
                            ...
                            try {
                                ...
                                out.println("<thead>");
                                out.println("<tr>");
                                out.println("<th scope = 'col' >Código do Gênero</th>");
                                out.println(" <th scope = 'col' >Nome do Gênero</th>");
                                out.println(" </tr>");
                                out.println(" </thead>");
                                out.println(" <tbody>");
